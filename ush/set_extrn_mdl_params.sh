...
# the ICs (specified in EXTRN_MDL_NAME_ICS).  These variables (with
# corresponding descriptions) are:
#
# EXTRN_MDL_FILES_BASEDIR_ICS:
...
# TRN_MDL_FILES_BASEDIR_ICS (which is the location where the preprocessing tasks
...
"GSMGFS")
  EXTRN_MDL_FILES_BASEDIR_ICS="${WORKDIR}/GSMGFS/ICS"
  ;;
"FV3GFS")
  EXTRN_MDL_FILES_BASEDIR_ICS="${WORKDIR}/FV3GFS/ICS"
  ;;
"RAPX")
  EXTRN_MDL_FILES_BASEDIR_ICS="${WORKDIR}/RAPX/ICS"
  ;;
"HRRRX")
  EXTRN_MDL_FILES_BASEDIR_ICS="${WORKDIR}/HRRRX/ICS"
  ;;
esac
#
#-----------------------------------------------------------------------

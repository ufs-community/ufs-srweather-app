...
#BSUB -n 1
#BSUB -R span[ptile=1]
#BSUB -o log.grid.regional_C768.%J
#BSUB -e log.grid.regional_C768.%J
#BSUB -J grid_fv3
#BSUB -q debug
##BSUB -M 2400
#BSUB -W 00:30
...
#SBATCH -q debug
#SBATCH -o log.grid.regional_C768.%j
#SBATCH -e log.grid.regional_C768.%j
#SBATCH --exclusive
#SBATCH -D.
...
if [ $gtype = uniform ];  then
  ...
  export title=c768r	 # identifier based on nest location
  if [ $gtype = nest ];then

...
#       large enough such that the "shave" steps later below (which 
#       take this file as input and generate grid files with thinner ha-
#       los) have a wide enough starting halo to work with.  More speci-
#       fically, the FV3SAR model needs as inputs two grid files: one 
#       with a halo that is 3 cells and another with a halo that is 4
#       cells wide.  Thus, the halo in the grid file that the grid_gen_-
#       scr script generates must be greater than 4 since otherwise, the

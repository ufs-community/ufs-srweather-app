...
.. code-block:: console
   ...
   wget https://noaa-ufs-srw-pds.s3.amazonaws.com/experiment-user-cases/release-public-v2.1.0/out-of-the-box/fix_data.tgz
...
.. code-block:: console
   ...
   wget https://noaa-ufs-srw-pds.s3.amazonaws.com/experiment-user-cases/release-public-v2.1.0/out-of-the-box/gst_data.tgz
...
(``gst_data.tgz``) containing the model data for this case is available in the `UFS SRW App Data Bucket <https://noaa-ufs-srw-pds.s3.amazonaws.com/index.html#experiment-user-cases/release-public-v2.1.0/out-of-the-box/>`__. 

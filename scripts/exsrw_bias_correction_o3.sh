...
task_global_vars=( "OMP_NUM_THREADS_BIAS_CORRECTION_O3" "PRE_TASK_CMDS" \
  "RUN_CMD_SERIAL" "PREDEF_GRID_NAME" "FCST_LEN_CYCL" "DATE_FIRST_CYCL" \
  "INCR_CYCL_FREQ" "DCOMINairnow" "FCST_LEN_HRS" )

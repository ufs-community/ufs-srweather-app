...
# background files
#
bgdawp=${COMOUT}/${NET}.${cycle}.bgdawpf${fhr}.${TMMARK}.grib2
bgrd3d=${COMOUT}/${NET}.${cycle}.bgrd3df${fhr}.${TMMARK}.grib2
bgsfc=${COMOUT}/${NET}.${cycle}.bgsfcf${fhr}.${TMMARK}.grib2
bgifi=${COMOUT}/${NET}.${cycle}.bgifif${fhr}.${TMMARK}.grib2
...
cp_vrfy ${bgdawp} ${COMOUT}/${NET}.${cycle}.bgdawpf${fhr}.${TMMARK}.grib2
cp_vrfy ${bgrd3d} ${COMOUT}/${NET}.${cycle}.bgrd3df${fhr}.${TMMARK}.grib2
if [ -f  ${bgifi} ]; then
  cp_vrfy ${bgifi} ${COMOUT}/${NET}.${cycle}.bgifif${fhr}.${TMMARK}.grib2
fi
cp_vrfy ${bgsfc}  ${COMOUT}/${NET}.${cycle}.bgsfcf${fhr}.${TMMARK}.grib2
ln_vrfy -sf --relative ${COMOUT}/${NET}.${cycle}.bgdawpf${fhr}.${TMMARK}.grib2 ${COMOUT}/BGDAWP_${basetime}${post_fhr}
ln_vrfy -sf --relative ${COMOUT}/${NET}.${cycle}.bgrd3df${fhr}.${TMMARK}.grib2 ${COMOUT}/BGRD3D_${basetime}${post_fhr}
if [ -f ${COMOUT}/${NET}.${cycle}.bgifif${fhr}.${TMMARK}.grib2 ]; then
  ln_vrfy -sf --relative ${COMOUT}/${NET}.${cycle}.bgifif${fhr}.${TMMARK}.grib2 ${COMOUT}/BGIFI_${basetime}${post_fhr}
fi
ln_vrfy -sf --relative ${COMOUT}/${NET}.${cycle}.bgsfcf${fhr}.${TMMARK}.grib2  ${COMOUT}/BGSFC_${basetime}${post_fhr}

net4=$(echo ${NET:0:4} | tr '[:upper:]' '[:lower:]')
ln_vrfy -sf --relative ${COMOUT}/${NET}.${cycle}.bgdawpf${fhr}.${TMMARK}.grib2 ${COMOUT}/${net4}.${cycle}.prslev.f${fhr}.${gridname}grib2
wgrib2 ${COMOUT}/${net4}.${cycle}.prslev.f${fhr}.${gridname}grib2 -s > ${COMOUT}/${net4}.${cycle}.prslev.f${fhr}.${gridname}grib2.idx
ln_vrfy -sf --relative ${COMOUT}/${NET}.${cycle}.bgrd3df${fhr}.${TMMARK}.grib2 ${COMOUT}/${net4}.${cycle}.natlev.f${fhr}.${gridname}grib2
wgrib2 ${COMOUT}/${net4}.${cycle}.natlev.f${fhr}.${gridname}grib2 -s > ${COMOUT}/${net4}.${cycle}.natlev.f${fhr}.${gridname}grib2.idx
if [ -f ${COMOUT}/${NET}.${cycle}.bgifif${fhr}.${TMMARK}.grib2 ]; then
  ln_vrfy -sf --relative ${COMOUT}/${NET}.${cycle}.bgifif${fhr}.${TMMARK}.grib2 ${COMOUT}/${net4}.${cycle}.ififip.f${fhr}.${gridname}grib2
  wgrib2 ${COMOUT}/${net4}.${cycle}.ififip.f${fhr}.${gridname}grib2 -s > ${COMOUT}/${net4}.${cycle}.ififip.f${fhr}.${gridname}grib2.idx
fi
ln_vrfy -sf --relative ${COMOUT}/${NET}.${cycle}.bgsfcf${fhr}.${TMMARK}.grib2  ${COMOUT}/${net4}.${cycle}.testbed.f${fhr}.${gridname}grib2
...
if [ ${#ADDNL_OUTPUT_GRIDS[@]} -gt 0 ]; then
  ...
  do
    ...
    do
      ...
      mkdir -p ${subdir}/${fhr}
      bg_remap=${subdir}/${NET}.${cycle}.bg${leveltype}f${fhr}.${TMMARK}.grib2
      ...
      cp_vrfy ${bg_remap} ${COMOUT}/${grid}_grid/${NET}.${cycle}.bg${leveltype}f${fhr}.${TMMARK}.grib2

      if [ $leveltype = 'dawp' ]; then
         ln_vrfy -fs --relative ${COMOUT}/${grid}_grid/${NET}.${cycle}.bg${leveltype}f${fhr}.${TMMARK}.grib2 ${COMOUT}/${net4}.${cycle}.prslev.f${fhr}.${gridname}grib2
         wgrib2 ${COMOUT}/${net4}.${cycle}.prslev.f${fhr}.${gridname}grib2 -s > ${COMOUT}/${net4}.${cycle}.prslev.f${fhr}.${gridname}grib2.idx
      fi

      if [ $leveltype = 'rd3d' ]; then
         ln_vrfy -fs --relative ${COMOUT}/${grid}_grid/${NET}.${cycle}.bg${leveltype}f${fhr}.${TMMARK}.grib2 ${COMOUT}/${net4}.${cycle}.natlev.f${fhr}.${gridname}grib2
         wgrib2 ${COMOUT}/${net4}.${cycle}.natlev.f${fhr}.${gridname}grib2 -s > ${COMOUT}/${net4}.${cycle}.natlev.f${fhr}.${gridname}grib2.idx
      fi

      if [[ $leveltype = 'ifi' ]] && [[ -f ${COMOUT}/${grid}_grid/${NET}.${cycle}.bg${leveltype}f${fhr}.${TMMARK}.grib2  ]]; then
         ln_vrfy -fs --relative ${COMOUT}/${grid}_grid/${NET}.${cycle}.bg${leveltype}f${fhr}.${TMMARK}.grib2 ${COMOUT}/${net4}.${cycle}.ififip.f${fhr}.${gridname}grib2
         wgrib2 ${COMOUT}/${net4}.${cycle}.ififip.f${fhr}.${gridname}grib2 -s > ${COMOUT}/${net4}.${cycle}.ififip.f${fhr}.${gridname}grib2.idx
      fi

      if [ $leveltype = 'sfc' ]; then
         ln_vrfy -fs --relative ${COMOUT}/${grid}_grid/${NET}.${cycle}.bg${leveltype}f${fhr}.${TMMARK}.grib2 ${COMOUT}/${net4}.${cycle}.testbed.f${fhr}.${gridname}grib2
         wgrib2 ${COMOUT}/${net4}.${cycle}.testbed.f${fhr}.${gridname}grib2 -s > ${COMOUT}/${net4}.${cycle}.testbed.f${fhr}.${gridname}grib2.idx
      fi

      # Link output for transfer from Jet to web
      ln_vrfy -fs --relative ${COMOUT}/${grid}_grid/${NET}.${cycle}.bg${leveltype}f${fhr}.${TMMARK}.grib2 ${COMOUT}/${grid}_grid/BG${leveltype^^}_${basetime}${post_fhr}
    done
  done
fi

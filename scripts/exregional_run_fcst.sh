...
#-----------------------------------------------------------------------
#
# Call python script to set paths to the surface climatology files.
# These files were either pre-staged in a user-specified directory (SFC_CLIMO_DIR)
# or were generated by the TN_MAKE_SFC_CLIMO task.
#
#-----------------------------------------------------------------------
#
python3 $USHdir/set_fv3nml_sfc_climo_filenames.py \
  --path-to-defns ${GLOBAL_VAR_DEFNS_FP} --namelist ${DATA}/${FV3_NML_FN}\
    || print_err_msg_exit "\

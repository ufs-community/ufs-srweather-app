...
task_global_vars=( "DATE_FIRST_CYCL" "DO_ENSEMBLE" \
  "EXTRN_MDL_DATA_STORES" "EXTRN_MDL_FILES_ICS" "EXTRN_MDL_FILES_LBCS" \
  "EXTRN_MDL_SOURCE_BASEDIR_ICS" "EXTRN_MDL_SOURCE_BASEDIR_LBCS" \
  "EXTRN_MDL_SYSBASEDIR_ICS" "EXTRN_MDL_SYSBASEDIR_LBCS" \
  "EXTRN_MDL_VAR_DEFNS_FN" "FCST_LEN_CYCL" "FCST_LEN_HRS" \
  "FV3GFS_FILE_FMT_ICS" "FV3GFS_FILE_FMT_LBCS" "INCR_CYCL_FREQ" \
  "LBC_SPEC_INTVL_HRS" "NUM_ENS_MEMBERS" "SYMLINK_FIX_FILES" )

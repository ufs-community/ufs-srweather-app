...
.. attention::
   Although Jet has modulefiles in this release, it is no longer supported by EPIC.
   ...
   #. Configure the experiment: 
      ...
      .. code-block:: console
         ...
         task_get_extrn_ics:
           ...
           EXTRN_MDL_SOURCE_BASEDIR_ICS: /gpfs/f5/epic/world-shared/UFS_SRW_data/v3p0/input_model_data/FV3GFS/grib2/${yyyymmddhh}
         task_get_extrn_lbcs:
           USE_USER_STAGED_EXTRN_FILES: true
           EXTRN_MDL_SOURCE_BASEDIR_LBCS: /gpfs/f5/epic/world-shared/UFS_SRW_data/v3p0/input_model_data/FV3GFS/grib2/${yyyymmddhh}

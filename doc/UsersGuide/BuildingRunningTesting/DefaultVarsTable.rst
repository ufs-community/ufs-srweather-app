...
.. list-table::  Configuration variables specified in the config_defaults.yaml script
   ...
   * - Workflow
     - taskgroups, WORKFLOW_ID, RELATIVE_LINK_FLAG, USE_CRON_TO_RELAUNCH, CRON_RELAUNCH_INTVL_MNTS, CRONTAB_LINE, LOAD_MODULES_RUN_TASK_FP, EXPT_BASEDIR, EXPT_SUBDIR, EXEC_SUBDIR, 
   ...
   * - Rocoto
     - attrs, cycledefs, entities, log, tasks

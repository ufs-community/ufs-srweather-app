...
Users are encouraged to consult MM `Supported Plots <https://melodies-monet.readthedocs.io/en/stable/users_guide/supported_plots.html>`__ and `Supported Statistics <https://melodies-monet.readthedocs.io/en/stable/users_guide/supported_stats.html>`__ documentation for information on the plots and statistics generated by the MM tasks.

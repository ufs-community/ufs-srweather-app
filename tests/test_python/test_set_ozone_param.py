...
class Testing(unittest.TestCase):
    ...
    def setUp(self):
        self.CYCLEDIR_LINKS_TO_FIXam_FILES_MAPPING = [
            ...
            {"co2monthlycyc.txt": "co2monthlycyc.txt"}, {"global_h2oprdlos.f77":
                "global_h2o_pltc.f77"}, {"global_zorclim.1x1.grb": "global_zorclim.1x1.grb"},

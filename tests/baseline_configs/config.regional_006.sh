...
GRID_DIR="/scratch2/BMC/det/FV3LAM_pregen/grid/GSD_HRRR25km"

RUN_TASK_MAKE_OROG="FALSE"
OROG_DIR="/scratch2/BMC/det/FV3LAM_pregen/orog/GSD_HRRR25km"

RUN_TASK_MAKE_SFC_CLIMO="FALSE"
SFC_CLIMO_DIR="/scratch2/BMC/det/FV3LAM_pregen/sfc_climo/GSD_HRRR25km"

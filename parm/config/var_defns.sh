...
RUN_ENVIR='nco'
MACHINE='WCOSS2'
ACCOUNT='CONFIGURE-BY-NCO'
export HOMEaqm='CONFIGURE-BY-NCO'
...
METPLUS_CONF='${HOMEaqm}/parm/metplus'
MET_CONFIG='${HOMEaqm}/parm/met'
...
SCHED='pbspro'
PARTITION_DEFAULT=''
QUEUE_DEFAULT='CONFIGURE-BY-NCO'
PARTITION_HPSS=''
QUEUE_HPSS='CONFIGURE-BY-NCO'
PARTITION_FCST=''
QUEUE_FCST='CONFIGURE-BY-NCO'
RUN_CMD_SERIAL='time'
...
FIELD_DICT_FP='${HOMEaqm}/parm/config/fd_nems.yaml'
...
DO_REAL_TIME='TRUE'
COLDSTART='FALSE'
WARMSTART_CYCLE_DIR=CONFIGURE-BY-NCO
...
RUN_dfv='aqm'
model_ver_dfv='v7.0'
OPSROOT_dfv=CONFIGURE-BY-NCO
COMROOT_dfv=CONFIGURE-BY-NCO
COMIN_BASEDIR=CONFIGURE-BY-NCO
COMOUT_BASEDIR=CONFIGURE-BY-NCO
DATAROOT_dfv=CONFIGURE-BY-NCO
DCOMROOT_dfv=CONFIGURE-BY-NCO
LOGBASEDIR_dfv=CONFIGURE-BY-NCO
DBNROOT_dfv=''
SENDECF_dfv='FALSE'
SENDDBN_dfv='FALSE'
...
FIXaqmnexus_gfs_sfc='${HOMEaqm}/fix/gfs'
...
COMINbicor='CONFIGURE-BY-NCO'
COMOUTbicor='CONFIGURE-BY-NCO'

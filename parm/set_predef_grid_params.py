...
def set_predef_grid_params(PARMsrw, grid_name, quilting):
    """Sets grid parameters for the specified predefined grid

    Args:
        PARMsrw:      path to the SRW parm directory
    ...
    params_dict = load_config_file(os.path.join(PARMsrw, "predef_grid_params.yaml"))
    try:
